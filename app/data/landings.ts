...
export const landings: LandingPage[] = [
  ...
  },
  {
    ...
    seoParagraphs: [
      ...
      [{ text: 'Zit je in je examenjaar? Bekijk dan ook onze ' }, { text: 'examentraining', to: '/examentraining' }, { text: '. De bijles havo is ' }, { text: 'aan huis', to: '/bijles-aan-huis-groningen' }, { text: ' in Groningen. Bekijk onze ' }, { text: 'tarieven', to: '/tarieven' }, { text: ' en start met een gratis proefles.' }],
    ],
  },
  {
    slug: 'vwo',
    ...
    seoParagraphs: [
      ...
      [{ text: 'Zit je in vwo 5 of 6? Bekijk dan ook onze ' }, { text: 'examentraining', to: '/examentraining' }, { text: ' voor gerichte examenvoorbereiding. De bijles vwo is ' }, { text: 'aan huis', to: '/bijles-aan-huis-groningen' }, { text: ' in Groningen. Bekijk onze ' }, { text: 'tarieven', to: '/tarieven' }, { text: ' en start met een gratis proefles.' }],
    ],
  },
  {
    slug: 'aan-huis',
